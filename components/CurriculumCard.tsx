      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-2">
              <div className="min-w-10 w-auto px-3 h-10 rounded-full bg-white/10 border border-white/10 flex items-center justify-center text-blue-100 font-mono text-sm group-hover:bg-brand-yellow group-hover:text-black font-bold transition-all duration-300">
                {order}
              </div>
          </div>
